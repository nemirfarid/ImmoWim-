        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-1 bg-slate-100/70 p-1.5 rounded-2xl border border-slate-200/60">
            <button
              ...
              onClick={() => {
                setCurrentTab('home');
                const el = document.getElementById('diaspora-section-banner');
                if (el) {
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-black bg-gradient-to-r from-emerald-600 to-amber-600 text-white shadow-xs hover:shadow-md transition-all cursor-pointer active:scale-95"
              title="Espace Diaspora Algérienne & Immigrés"
            >
              <span>🇩🇿 Diaspora</span>
              <span className="hidden xl:inline text-[10px] bg-black/30 px-1.5 py-0.5 rounded-full">€ / $ CAD</span>
            </button>
