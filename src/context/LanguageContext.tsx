...
const translations: Record<Language, Translations> = {
  FR: {
    ...
    heroBadge: "Plateforme N°1 d'Estimation & Transaction Immobilière en Algérie",
    heroTagline: "L'Immobilier d'Exception en Algérie",
    heroSubtitle: "Recherchez, vendez et estimez la vraie valeur de vos biens immobiliers en toute transparence, avec un accompagnement dédié pour la diaspora et les acheteurs.",
  ...
  EN: {
    ...
    heroBadge: "#1 Real Estate Valuation & Transaction Platform in Algeria",
    heroTagline: "Premium Real Estate in Algeria",
    heroSubtitle: "Search, sell and evaluate the real market value of properties with full transparency and dedicated support for diaspora and buyers.",
  ...
  AR: {
    ...
    heroBadge: "المنصة رقم 1 للتقييم والمعاملات العقارية في الجزائر",
    heroTagline: "العقارات الفاخرة في الجزائر",
    heroSubtitle: "ابحث، بع، وقيم القيمة الحقيقية لعقاراتك بكل شفافية، مع مرافقة مخصصة للجالية والمستثمرين والمشترين.",
